    ...
    <section className="relative min-h-screen flex items-center justify-center py-24 bg-black overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        ...
        >
          ...
          <h2 className="font-heading text-4xl md:text-8xl font-black text-white uppercase tracking-tighter leading-none mb-8">
            SETTLING <br />
            <span className="text-[#D4AF37] neon-text-gold">FOR LESS</span>
          </h2>
          
          <p className="text-zinc-300 text-lg md:text-2xl mb-12 font-light max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center px-4">
            <motion.a 
              ...
              className="bg-pink-500 text-white px-8 md:px-10 py-5 md:py-6 rounded-md font-heading font-black text-xs md:text-sm uppercase tracking-[0.2em] shadow-2xl neon-border-pink flex flex-col items-center cursor-pointer"
            >
            ...
            <motion.a 
              ...
              whileHover={{ scale: 1.05 }}
              className="bg-[#D4AF37] text-black px-8 md:px-10 py-5 md:py-6 rounded-md font-heading font-black text-xs md:text-sm uppercase tracking-[0.2em] shadow-2xl neon-border-gold flex flex-col items-center cursor-pointer"
            >
          ...
          <div className="mt-12">
             <p className="text-zinc-500 text-[10px] md:text-xs font-bold uppercase tracking-widest leading-relaxed">
