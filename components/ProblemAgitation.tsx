        ...
        <div className="grid md:grid-cols-3 gap-8">
          {cards.map((card, idx) => (
            <motion.div
              ...
              className="bg-zinc-900 p-8 rounded-2xl border border-zinc-800 hover:border-pink-500/50 transition-all group"
            >
              <div className="font-heading text-4xl md:text-5xl font-black text-pink-500 mb-4 group-hover:scale-110 transition-transform origin-left">
                {card.number}
              </div>
